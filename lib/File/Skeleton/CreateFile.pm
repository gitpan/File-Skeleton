package File::Skeleton::CreateFile;
# TODO: rename to File::Skeleton::Summoner
...
use File::Skeleton::Register qw(chooseSkeleton registerSkeleton);

=head1 NAME

File::Skeleton::CreateFile - The great new File::Skeleton::CreateFile!
...
=head1 SYNOPSIS
    ...
    my $summoner = File::Skeleton::CreateFile->new();
...
sub summonFile {
    ...
    my @skeletonDirs =
      File::Skeleton::SkeletonDirsFinder->new->findForFile( $fileName );
...
You can find documentation for this module with the perldoc command.
    ...
    perldoc File::Skeleton::CreateFile
...
1;    # End of File::Skeleton::CreateFile
